...
import com.bluetaxi.driver.Login.LoginActivity;
import com.bluetaxi.driver.Login.VerificationActivity;
...
import com.bluetaxi.driver.permission.DevicePermissionActivity;
import com.bluetaxi.driver.permission.StoreAndSecureActivity;
...
//                }
    ...
    protected void onResume() {
        ...
        if (MainActivity.this != null) {
            ...
            if (SessionSave.getSession("user_privacy_policy", MainActivity.this).equals("")) {
                if (!((this instanceof DevicePermissionActivity) || (this instanceof SplashAct) || (this instanceof StoreAndSecureActivity) || (this instanceof LoginActivity) || (this instanceof VerificationActivity) || (this instanceof DriverRegisterActStepOne || (this instanceof AddFleetAct)|| (this instanceof VideoActivity)))) {
                    Intent i = new Intent(MainActivity.this, DevicePermissionActivity.class);
                    i.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK|Intent.FLAG_ACTIVITY_NEW_TASK);
                    startActivity(i);
                }
            } else {
                if (SessionSave.getSession("Id", MainActivity.this).trim().equals("")) {
                    if (!((this instanceof UserLoginAct) || (this instanceof SplashAct)|| (this instanceof DriverRegisterActStepOne)||(this instanceof LoginActivity)||(this instanceof VerificationActivity) || (this instanceof AddFleetAct)|| (this instanceof VideoActivity))) {
    ...
    public void alert_view(Context mContext, String title, String message, String success_txt, String failure_txt) {
        ...
        Colorchange.ChangeColor(alertDialog.findViewById(R.id.alert_id), mContext);
