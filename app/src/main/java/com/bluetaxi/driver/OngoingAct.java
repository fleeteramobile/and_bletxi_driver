...
import static com.bluetaxi.driver.StreetPickUpAct.WAITING_TIME_RUN;
import static com.bluetaxi.driver.service.LocationUpdate.currentAccuracy;
import static com.bluetaxi.driver.service.LocationUpdate.localDistance;
import static com.bluetaxi.driver.service.LocationUpdate.runningFor;
import static com.bluetaxi.driver.service.LocationUpdate.slabAccuracy;
...
import com.bluetaxi.driver.adapter.SelectedServiceAdapter;
import com.bluetaxi.driver.adapter.StopListAdapter;
import com.bluetaxi.driver.data.CommonData;
import com.bluetaxi.driver.data.MapWrapperLayout;
...
import com.bluetaxi.driver.interfaces.GetAddress;
import com.bluetaxi.driver.interfaces.LocalDistanceInterface;
import com.bluetaxi.driver.interfaces.Pickupupdate;
import com.bluetaxi.driver.pdview.PickupDropView;
...
import com.bluetaxi.driver.toll.TollInformation;
import com.bluetaxi.driver.utils.CToast;
import com.bluetaxi.driver.utils.Colorchange;
import com.bluetaxi.driver.utils.FontHelper;
import com.bluetaxi.driver.utils.GetAddressFromLatLng;
import com.bluetaxi.driver.utils.GpsStatus;
import com.bluetaxi.driver.utils.LatLngInterpolator;
import com.bluetaxi.driver.utils.LocationUtils;
import com.bluetaxi.driver.utils.NC;
import com.bluetaxi.driver.utils.RoundedImageView;
import com.bluetaxi.driver.utils.ServiceItem;
...
public class OngoingAct extends MainActivity implements ClickInterface, OnMapReadyCallback, LocalDistanceInterface, GoogleMap.OnCameraMoveStartedListener, GetAddress {
    ...
    private TextView nodataTxt, passnameTxt, speedTxt,origin_name,destination_name;
    ...
    private LinearLayout bottom_action_buttons_container;
...
//                        route.drawRoute(map, OngoingAct.this, pickupLatLng, dropLatLng, "en", Color.parseColor("#00BFFF"));
    ...
    public void Initialize() {
        ...
        bottom_action_buttons_container = findViewById(R.id.bottom_action_buttons_container);
...
//                    }
        ...
        backup.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                Intent jobintent = new Intent(OngoingAct.this, HomeScreenActivity.class);
...
//
        ...
        btn_confirm.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (verifyno1Txt.getText().toString().equals("")) {
                    ...
                    Toast.makeText(OngoingAct.this, "Enter fifth number", Toast.LENGTH_LONG).show();

                } else

                if (verifyno6Txt.getText().toString().equals("")) {
                    Toast.makeText(OngoingAct.this, "Enter odameter number", Toast.LENGTH_LONG).show();
    ...
    private void showDialogWithDropdown() {
        ...
        alertDialog.setOnShowListener(dialog -> {
            alertDialog.getButton(AlertDialog.BUTTON_POSITIVE).setTextColor(getResources().getColor(R.color.app_theme_color));
                    ...
                    try {
                        ...
                        if (listPoint.size() > 1) {
                            ...
                            if (!animStarted) {
                                ...
                                if (SessionSave.getSession("model_name", OngoingAct.this).equals("Auto")) {
                                    c_marker = map.addMarker(new MarkerOptions().position(listPoint.get(0)).rotation(0).anchor(0.5f, 0.5f).title(Address).icon(BitmapDescriptorFactory.fromResource(R.drawable.auto)));

                                } else if (SessionSave.getSession("model_name", OngoingAct.this).equals("Bike")) {
                                    c_marker = map.addMarker(new MarkerOptions().position(listPoint.get(0)).rotation(0).anchor(0.5f, 0.5f).title(Address).icon(BitmapDescriptorFactory.fromResource(R.drawable.bike)));
                                ...
                                if (speed > 20 && map != null) {
                                    ...
                                    if (GpsStatus.ischecked == 0) {
                                        ...
                                        if (SessionSave.getSession("model_name", OngoingAct.this).equals("Auto")) {
                                            a_marker = map.addMarker(new MarkerOptions().position(latLng).rotation(0).anchor(0.5f, 0.5f).title(Address).icon(BitmapDescriptorFactory.fromResource(R.drawable.auto)));

                                        } else if (SessionSave.getSession("model_name", OngoingAct.this).equals("Bike")) {
                                            a_marker = map.addMarker(new MarkerOptions().position(latLng).rotation(0).anchor(0.5f, 0.5f).title(Address).icon(BitmapDescriptorFactory.fromResource(R.drawable.bike)));
                                        ...
                                        if (SessionSave.getSession("model_name", OngoingAct.this).equals("Auto")) {
                                            a_marker = map.addMarker(new MarkerOptions().position(listPoint.get(0)).rotation(0).anchor(0.5f, 0.5f).title(Address).icon(BitmapDescriptorFactory.fromResource(R.drawable.auto)));

                                        } else if (SessionSave.getSession("model_name", OngoingAct.this).equals("Bike")) {
                                            a_marker = map.addMarker(new MarkerOptions().position(listPoint.get(0)).rotation(0).anchor(0.5f, 0.5f).title(Address).icon(BitmapDescriptorFactory.fromResource(R.drawable.bike)));
    ...
    private void RetryLocationPopUp() {
        ...
        if (retryCount > 2) {
            dialog1 = Utils.alert_view_dialog(OngoingAct.this, NC.getResources().getString(R.string.message), NC.getString(R.string.address_cant_fetch), NC.getString(R.string.retry), NC.getString(R.string.use_map), false, (dialog, which) -> {
                ...
                Intent intent = new Intent(OngoingAct.this, SelectDropLocationAct.class);
...
// in a raw resource file.
            ...
            try {
                ...
                if (resultCode == ConnectionResult.SUCCESS) {
                    ...
                    Picasso.get().load(imagepath).placeholder(getResources().getDrawable(R.drawable.loadingimage)).error(getResources().getDrawable(R.drawable.noimage)).into(proimg);
...
//            myHandler.postDelayed(r, 0);
    ...
    public void onBackPressed() {
        ...
        if (taskList.get(0).numActivities == 1 &&
            ...
            startActivity(new Intent(OngoingAct.this, HomeScreenActivity.class));
            finish();
        } else {
            super.onBackPressed();
        }
        ...
        animator.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if (c_marker != null && map != null) {
                    ...
                    c_marker.remove();
                    if (SessionSave.getSession("model_name", OngoingAct.this).equals("Auto")) {
                        a_marker = map.addMarker(new MarkerOptions().position(savedLatLng).rotation(0).anchor(0.5f, 0.5f).title(NC.getResources().getString(R.string.you_are_here)).icon(BitmapDescriptorFactory.fromResource(R.drawable.auto)));

                    } else if (SessionSave.getSession("model_name", OngoingAct.this).equals("Bike")) {
                        a_marker = map.addMarker(new MarkerOptions().position(savedLatLng).rotation(0).anchor(0.5f, 0.5f).title(NC.getResources().getString(R.string.you_are_here)).icon(BitmapDescriptorFactory.fromResource(R.drawable.bike)));
            ...
            try {
                if (isSuccess) {
                    ...
                    if (json.getInt("status") == 1) {
                        ...
                        final Intent jobintent = new Intent(OngoingAct.this, HomeScreenActivity.class);
...
//                        lay_fare.setVisibility(View.VISIBLE);
                        ...
                        Intent intent = new Intent(OngoingAct.this, HomeScreenActivity.class);
                        startActivity(intent);
                        finish();
                    } else {
//                        lay_fare.setVisibility(View.VISIBLE);
            ...
            try {
                if (isSuccess) {
                    ...
                    if (json.getInt("status") == 3 || json.getInt("status") == 7) {
                        ...
                        ComponentName cn = new ComponentName(OngoingAct.this, HomeScreenActivity.class);
                ...
                if (isSuccess) {
                    ...
                    if (json.getInt("status") == 1) {
                        ...
                        if (detail.getString("street_pickup_trip").trim().equals("1")) {
                            ...
                            double dropLat = Double.parseDouble(p_droplat);
                            double dropLng = Double.parseDouble(p_droplng);


                            String pickupCity = getCityName(OngoingAct.this, pickupLat, pickupLng);
                            String dropCity = getCityName(OngoingAct.this, dropLat, dropLng);


                            origin_name.setText(pickupCity);
                            destination_name.setText(dropCity);
...
//                                    }
                                ...
                                if (!SessionSave.getSession("p_image", OngoingAct.this).equals("")) {
                                    ...
                                    imagepath = SessionSave.getSession("noimage_base", OngoingAct.this);
                                Picasso.get().load(imagepath).placeholder(getResources().getDrawable(R.drawable.loadingimage)).error(getResources().getDrawable(R.drawable.noimage)).into(proimg);
                                Picasso.get().load(imagepath).placeholder(getResources().getDrawable(R.drawable.loadingimage)).error(getResources().getDrawable(R.drawable.noimage)).into(profile_avatar);
    ...
    private String getCityName(Context context, double latitude, double longitude) {
        ...
        try {
            ...
            if (addresses != null && !addresses.isEmpty()) {
                ...
                cityName = address.getLocality(); // Preferred
                if (cityName == null) {
                    cityName = address.getSubAdminArea(); // Fallback
                }
            }
        } catch (IOException e) {
            e.printStackTrace();
        ...
        btn_confirm.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (verifyno1Txt.getText().toString().equals("")) {
                    ...
                    Toast.makeText(OngoingAct.this, "Enter sixth number", Toast.LENGTH_LONG).show();
...
//
        TextView btn_confirm = myOTPDialog.findViewById(R.id.btn_confirm);
...
//            myHandler.removeCallbacks(r);
    ...
    private class showServiceList implements APIResult {
         ...
         */
        public void getResult(final boolean isSuccess, final String result) {
            // This is where you re-enable the button after the API call
          //  butt_onboard.setEnabled(true);
            try {
                if (isSuccess) {
                    System.out.println("service_type" + " "+"1");

                    final JSONObject json = new JSONObject(result);
                    // Check if the API call was successful based on the JSON status
                    if (json.optInt("status", 0) == 1) { // Assuming "status":1 means success
                        System.out.println("service_type" + " "+"2");

                        JSONArray dataArray = json.optJSONArray("data");
                        if (dataArray != null) {
                            System.out.println("service_type" + " "+"3");

                            // Clear previous data before populating
                            allServices.clear();
                            for (int i = 0; i < dataArray.length(); i++) {
                                JSONObject serviceJson = dataArray.getJSONObject(i);
                                int _id = serviceJson.getInt("_id");
                                double service_amount = serviceJson.getDouble("service_amount");
                                String status = serviceJson.getString("status");
                                String service_type = serviceJson.getString("service_type");
                                allServices.add(new ServiceItem(_id, service_amount, status, service_type));
                                System.out.println("service_type" + " "+service_type);
                            }

                            // Now that data is parsed, show the dialog on the UI thread
                            runOnUiThread(new Runnable() {
                                @Override
                                public void run() {
                            ...
                            runOnUiThread(new Runnable() {
                                public void run() {
                                    ShowToast(OngoingAct.this, "No service data found.");
                                }
                            });
                        }
                    } else {
                        // API call successful, but status is not 1 (e.g., "message":"No data")
                        final String errorMessage = json.optString("message", NC.getString(R.string.server_error));
                        runOnUiThread(new Runnable() {
                            public void run() {
                                ShowToast(OngoingAct.this, errorMessage);
                            }
                        });
                    }
                } else {
                ...
                runOnUiThread(new Runnable() {
                    public void run() {
                        ShowToast(OngoingAct.this, "Error processing server response.");
                    }
                });
            }
        }
