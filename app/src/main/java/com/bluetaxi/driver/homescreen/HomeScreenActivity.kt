...
import com.bluetaxi.driver.service.FirebaseService
...
class HomeScreenActivity : AppCompatActivity(), ClickInterface,
    ...
    Glide.with(this@HomeScreenActivity)
                    ...
                    val totalAmount = json.getString("total_amount")
                    ...
                    val totalShiftHrs = json.getString("total_shift_hrs")
...
SessionSave.saveSession("model_id",modelId.toString(),this@HomeScreenActivity)
                    ...
                    if (json.has("total_trips")) {
                        val total_trips = json.getJSONArray("total_trips")
                    }
