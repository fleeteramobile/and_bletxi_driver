...
import static com.bluetaxi.driver.utils.GpsStatus.mDialog;
...
public class WebviewAct extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String btnRjt = "";
        try {
            btnAct = Integer.toHexString(CL.getColor(R.color.button_accept)).substring(2);
            btnRjt = Integer.toHexString(CL.getColor(R.color.button_reject)).substring(2);
        } catch (Exception e) {
            e.printStackTrace();
        }
        try {
    ...
    public void showDialog() {
        try {
            if (NetworkStatus.isOnline(WebviewAct.this)) {
                ...
                Colorchange.ChangeColor((ViewGroup) view, WebviewAct.this);
    ...
    public void onBackPressed() {
        ...
        if (!TextUtils.isEmpty(fromAct)) {
            startActivity(new Intent(WebviewAct.this, HomeScreenActivity.class));
            finish();
        }
        super.onBackPressed();
    }
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        if ((keyCode == KeyEvent.KEYCODE_BACK) && simpleWebView.canGoBack()) {
            if (type.equals("12")) {
                ...
                startActivity(new Intent(WebviewAct.this, EarningsAct.class));
                finish();
            } else {
                startActivity(new Intent(WebviewAct.this, MeAct.class));
                finish();
            }
    ...
    private class MyWebViewClient extends WebViewClient {
        ...
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
            if (url.contains(SessionSave.getSession("api_base", WebviewAct.this) + "back.html")) {
                if (!TextUtils.isEmpty(fromAct)) {
                    startActivity(new Intent(WebviewAct.this, MyStatus.class));
                    finish();
                ...
                Intent intent = new Intent(WebviewAct.this, UserLoginAct.class);
        ...
        private void callProfile() {
            Intent i = new Intent(WebviewAct.this, MeAct.class);
            startActivity(i);
        }
