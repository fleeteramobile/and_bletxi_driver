package com.bluetaxi.driver.tracklocation
...
//            if (SessionSave.getSession("model_name",this@TrackLocationActivity).equals("Auto"))
//            {
                carIcon = BitmapFactory.decodeResource(resources, R.drawable.auto)
//            }
