...
import com.bluetaxi.driver.roomDB.GoogleMapModel;
import com.bluetaxi.driver.roomDB.MapLoggerRepository;
                        ...
                        try {
                          ...
                          //  set.cancel();
                            ...
                            if (NotificationAct.this != null) {
                                final Intent intent = new Intent(NotificationAct.this, HomeScreenActivity.class);
