...
import com.bluetaxi.driver.data.apiData.SettlementHistoryData;
import com.bluetaxi.driver.data.apiData.SettlementPaymentData;
import com.bluetaxi.driver.data.apiData.SettlementReqData;
...
public interface CoreClient {
    ...
    Call<Earningresponse> callData(@Path(value = "owner", encoded = true) String owner, @Body ApiRequestData.Earnings body);
