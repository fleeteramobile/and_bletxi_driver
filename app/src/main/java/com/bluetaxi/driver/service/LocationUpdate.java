...
import static com.bluetaxi.driver.MainActivity.mMyStatus;
...
import com.bluetaxi.driver.utils.ElevationHelper;
...
import com.bluetaxi.driver.BuildConfig;
import com.bluetaxi.driver.CallReceiver;
import com.bluetaxi.driver.MyApplication;
import com.bluetaxi.driver.NotificationAct;
...
import com.bluetaxi.driver.errorLog.ErrorLogRepository;
import com.bluetaxi.driver.interfaces.APIResult;
import com.bluetaxi.driver.interfaces.DistanceMatrixInterface;
import com.bluetaxi.driver.interfaces.Pickupupdate;
import com.bluetaxi.driver.interfaces.StreetPickupInterface;
import com.bluetaxi.driver.route.FindApproxDistance;
import com.bluetaxi.driver.utils.CL;
import com.bluetaxi.driver.utils.DistanceMatrixUtil;
import com.bluetaxi.driver.utils.DriverUtils;
import com.bluetaxi.driver.utils.ExceptionConverter;
...
//                            stopService(new Intent(LocationUpdate.this, WaitingTimerRun.class));
            ...
            // For getting SMS From Passenger
                ...
                LocationUpdate.this.stopSelf();
                String lTaximobilityutlmsg = "";
                // generateNotifications(LocationUpdate.this, json.getString("message"), CanceltripAct.class, false, Notification_ID);
                lTaximobilityutlmsg = json.getString("message");
