...
import com.bluetaxi.driver.MyStatus;
...
import com.bluetaxi.driver.data.apiData.DetailInfo;
    ...
    protected void onHandleIntent(RemoteMessage remoteMessage) {// Handling gcm message from
        ...
        try {
            ...
            if (!message.isEmpty()) {
                ...
                generateNotification(this, message,tripId, status,UserLoginAct.class);// to handle book later schedule
                ...
                if (status.equals("14")) {
                    ...
                    if (!tripId.equals("")) {
                        generateNotification(this, message, tripId, status, UserLoginAct.class);
                    }
    ...
    private void sendNotification(String msg) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
            ...
            contentIntent = PendingIntent.getActivity(this,
                    0, new Intent(this, HomeScreenActivity.class), PendingIntent.FLAG_UPDATE_CURRENT | PendingIntent.FLAG_MUTABLE);

        }else {
            System.out.println("received_notufication_inside"+ " "+"3");

            contentIntent =  PendingIntent.getActivity(this, 0, new Intent(this, HomeScreenActivity.class), PendingIntent.FLAG_IMMUTABLE);
    ...
    private void showNotification(Context context, String Message, String data) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                ...
                builder.setSmallIcon(R.drawable.ic_app_logo_new);
            }
