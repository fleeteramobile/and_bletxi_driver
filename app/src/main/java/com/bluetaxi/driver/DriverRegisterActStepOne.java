        ...
        btn_nxt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (TextUtils.isEmpty(edt_first_name.getText().toString().trim())) {
                    CToast.ShowToast(com.bluetaxi.driver.DriverRegisterActStepOne.this, NC.getResources().getString(R.string.enter_the_first_name));
                } else if (edt_first_name.getText().toString().trim().length() < 1) {
                    CToast.ShowToast(com.bluetaxi.driver.DriverRegisterActStepOne.this, NC.getResources().getString(R.string.error_first_name));
                } else if (TextUtils.isEmpty(gender.trim())) {
                    CToast.ShowToast(com.bluetaxi.driver.DriverRegisterActStepOne.this, NC.getResources().getString(R.string.select_gender));
                }
                    ...
                    CToast.ShowToast(com.bluetaxi.driver.DriverRegisterActStepOne.this, NC.getResources().getString(R.string.enter_the_password));
                } else if (edt_pswd.getText().toString().trim().length() < 5) {
                    CToast.ShowToast(com.bluetaxi.driver.DriverRegisterActStepOne.this, NC.getResources().getString(R.string.pwd_min));
                } else if (TextUtils.isEmpty(edt_cnfrm_pswd.getText().toString().trim())) {
                    CToast.ShowToast(com.bluetaxi.driver.DriverRegisterActStepOne.this, NC.getResources().getString(R.string.enter_the_confirmation_password));
                } else if (!edt_pswd.getText().toString().trim().matches(edt_cnfrm_pswd.getText().toString().trim())) {
                    CToast.ShowToast(com.bluetaxi.driver.DriverRegisterActStepOne.this, NC.getResources().getString(R.string.confirmation_password_mismatch_with_password));
                    ...
                    CToast.ShowToast(com.bluetaxi.driver.DriverRegisterActStepOne.this, NC.getResources().getString(R.string.upload_profile));
                } else {
...
//                driver_info.put("national_id", nation_id_Edt.getText().toString().trim());
                ...
                if (isOnline()) {
                    new APIService_Retrofit_JSON(com.bluetaxi.driver.DriverRegisterActStepOne.this, this, driver_info, false).execute(url);
                } else {
                    dialog1 = Utils.alert_view(com.bluetaxi.driver.DriverRegisterActStepOne.this, NC.getResources().getString(R.string.message), NC.getResources().getString(R.string.check_net_connection), NC.getResources().getString(R.string.ok), "", true, com.bluetaxi.driver.DriverRegisterActStepOne.this, "");
                }
            } catch (Exception e) {
                ...
                if (isSuccess) {
                    ...
                    if (json.getInt("status") == 1) {
                        ...
                        if (json.has("details") && json.getJSONObject("details").has("driver_id")) {
                            ...
                            SessionSave.saveSession("driver_name", edt_first_name.getText().toString().trim(), com.bluetaxi.driver.DriverRegisterActStepOne.this);

                            SessionSave.saveSession("reg_driver_Id", driver_id, com.bluetaxi.driver.DriverRegisterActStepOne.this);
                            SessionSave.saveSession(CommonData.DRIVER_RESULT, result, com.bluetaxi.driver.DriverRegisterActStepOne.this);
                            SessionSave.saveSession("company_id", json.getJSONObject("details").getString("company_id"), com.bluetaxi.driver.DriverRegisterActStepOne.this);
                        ...
                        msg = json.getString("message");
                        dialog1 = Utils.alert_view(com.bluetaxi.driver.DriverRegisterActStepOne.this, NC.getResources().getString(R.string.message), msg, NC.getResources().getString(R.string.ok), "", true, com.bluetaxi.driver.DriverRegisterActStepOne.this, "");
                    }
                } else {
                ...
                if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
                    ...
                    if (photoFile != null) {
                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                            ...
                            imageUri = FileProvider.getUriForFile(com.bluetaxi.driver.DriverRegisterActStepOne.this,
                                    com.bluetaxi.driver.DriverRegisterActStepOne.this.getPackageName().concat(".files_root"),
                                    photoFile);
                        } else {
...
//        }
        ...
        try {
            ...
            if (requestcode == UCrop.REQUEST_CROP) {
                ...
                switch (requestcode) {
                    case 0:
                        try {
                            UCrop uCrop = UCrop.of(Uri.fromFile(new File(getRealPathFromURI(data.getDataString()))), Uri.fromFile(new File(com.bluetaxi.driver.DriverRegisterActStepOne.this.getCacheDir(), destinationFileName)))
                                    .useSourceImageAspectRatio().withAspectRatio(1, 1)
                                    .withMaxResultSize(400, 400);
                            UCrop.Options options = new UCrop.Options();
                            options.setToolbarColor(ContextCompat.getColor(com.bluetaxi.driver.DriverRegisterActStepOne.this, R.color.appbg));
                            options.setStatusBarColor(ContextCompat.getColor(com.bluetaxi.driver.DriverRegisterActStepOne.this, R.color.header_text));
                            options.setToolbarWidgetColor(ContextCompat.getColor(com.bluetaxi.driver.DriverRegisterActStepOne.this, R.color.header_text));
                            options.setMaxBitmapSize(1000000000);
                            uCrop.withOptions(options);
                            uCrop.start(com.bluetaxi.driver.DriverRegisterActStepOne.this);
                        } catch (final Exception e) {
                        }
                        break;
                    case 1:
                        try {
                            UCrop.of(imageUri, Uri.fromFile(new File(com.bluetaxi.driver.DriverRegisterActStepOne.this.getCacheDir(), destinationFileName)))
                                    .withAspectRatio(1, 1)
                                    .withMaxResultSize(2000, 2000)
                                    .start(com.bluetaxi.driver.DriverRegisterActStepOne.this);
                        } catch (final Exception e) {
                            e.printStackTrace();
                        }
                        break;
    ...
    private class ImageCompressionAsyncTask extends AsyncTask<String, Void, Bitmap> {
        ...
        protected void onPreExecute() {
            ...
            super.onPreExecute();
            final View view = View.inflate(com.bluetaxi.driver.DriverRegisterActStepOne.this, R.layout.progress_bar, null);
            mDialog = new Dialog(com.bluetaxi.driver.DriverRegisterActStepOne.this, R.style.NewDialog);
            ...
            Glide.with(com.bluetaxi.driver.DriverRegisterActStepOne.this)
        ...
        protected Bitmap doInBackground(final String... params) {
            ...
            try {
                ...
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        CToast.ShowToast(com.bluetaxi.driver.DriverRegisterActStepOne.this, NC.getResources().getString(R.string.image_failed));
                    }
                });
            }
            return mBitmap;
