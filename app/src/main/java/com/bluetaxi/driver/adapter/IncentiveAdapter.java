...
import com.bluetaxi.driver.IncentiveDetailActivity;
...
public class IncentiveAdapter  extends RecyclerView.Adapter<IncentiveAdapter.CustomViewHolder>{
    ...
    public IncentiveAdapter(Context mContext, List<IncentiveData> data) {
        this.mContext = mContext;
        this.data = data;
    }

    @Override
    public IncentiveAdapter.CustomViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(mContext);

        View view = inflater.inflate(R.layout.incentive_list_item, parent, false);
    ...
    @Override
    public void onBindViewHolder(@NonNull @NotNull IncentiveAdapter.CustomViewHolder holder, int position) {
    ...
    public class CustomViewHolder extends RecyclerView.ViewHolder {
        TextView title_Txt, inc_amtTxt,finish_dateTxt,showall_Txt;
