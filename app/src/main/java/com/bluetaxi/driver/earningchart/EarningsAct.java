package com.bluetaxi.driver.earningchart;
...
import com.bluetaxi.driver.BaseActivity;
import com.bluetaxi.driver.InboxActivity;
import com.bluetaxi.driver.MeAct;
import com.bluetaxi.driver.MyApplication;
import com.bluetaxi.driver.OngoingAct;
import com.bluetaxi.driver.OnmywayActivity;
...
import com.bluetaxi.driver.TripHistoryAct;
import com.bluetaxi.driver.WalletHistory;
import com.bluetaxi.driver.WebviewAct;
import com.bluetaxi.driver.WithDrawMenuAct;
import com.bluetaxi.driver.adapter.IncentiveAdapter;
import com.bluetaxi.driver.data.CommonData;
import com.bluetaxi.driver.data.IncentiveData;
import com.bluetaxi.driver.data.apiData.ApiRequestData;
import com.bluetaxi.driver.earningchart.dateadapter.DateListAdapter;
...
mChart.getAxisRight().setEnabled(false);
        ...
        home_lay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(EarningsAct.this, HomeScreenActivity.class);
                startActivity(intent);
                // finish();
            }
        });
