...
public class SelectDropLocationAct extends MainActivity implements View.OnClickListener, OnMapReadyCallback, GoogleMap.OnMapClickListener {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        } else if (!SessionSave.getSession(CommonData.SOS_LAST_LAT, SelectDropLocationAct.this).equals("")) {
            cameraUpdate = CameraUpdateFactory.newLatLngZoom(new LatLng(
                    Double.parseDouble(SessionSave.getSession(CommonData.SOS_LAST_LAT, SelectDropLocationAct.this))
                    , Double.parseDouble(SessionSave.getSession(CommonData.SOS_LAST_LNG, SelectDropLocationAct.this))), 16f);
        }
