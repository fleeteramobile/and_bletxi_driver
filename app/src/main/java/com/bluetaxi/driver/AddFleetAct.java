...
import com.bluetaxi.driver.data.ColorInfo;
import com.bluetaxi.driver.data.VehicleModelInfo;
import com.bluetaxi.driver.data.apiData.ModelListInfo;
import com.bluetaxi.driver.data.apiData.StateInfo;
import com.bluetaxi.driver.data.apiData.VehicleListInfo;
import com.bluetaxi.driver.data.apiData.VehiclePrefixInfo;
                ...
                if (isSuccess) {
                    ...
                    if (json.getInt("status") == 1) {
                      ...
                      //  success_dialog(json.getJSONObject("details").getString("skip_video"));
                        ...
                        Intent i = new Intent(AddFleetAct.this, UserLoginAct.class);
...
//                        i.putExtras(bundle);
    ...
    private void success_dialog(String skip_video) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(AddFleetAct.this);
        ViewGroup viewGroup = findViewById(android.R.id.content);
        View dialogView = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.success_dialog, viewGroup, false);
        builder.setView(dialogView);
        FontHelper.applyFont(this, alertDialog.findViewById(R.id.inner_content));
        ...
        okbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
               // if (skip_video.equalsIgnoreCase("1")) {
                    Intent intent = new Intent(AddFleetAct.this, UserLoginAct.class);
                    intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    startActivity(intent);
                    finish();
                    alertDialog.dismiss();
//                } else {
//                    Intent intent = new Intent(AddFleetAct.this, VideoActivity.class);
//                    intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
//                    startActivity(intent);
//                    finish();
//                    alertDialog.dismiss();
//                }
   ...
   /* private void video_dialog() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(AddFleetAct.this);
        ViewGroup viewGroup = findViewById(android.R.id.content);
        View dialogView = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.video_dialog, viewGroup, false);
        builder.setView(dialogView);
        alertDialog = builder.create();
        alertDialog.setCancelable(true);
        Button okbtn = dialogView.findViewById(R.id.okbtn);
        ...
        VideoView videoView =dialogView.findViewById(R.id.vdVw);
        MediaController mediaController= new MediaController(this);
        mediaController.setAnchorView(videoView);
        Uri uri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.example);
...
//        startActivityForResult(intent, REQUEST_CODE);
        ...
        dialog1 = Utils.alert_view_dialog(this, NC.getResources().getString(R.string.profile_image), NC.getResources().getString(R.string.choose_an_image), NC.getResources().getString(R.string.camera), NC.getResources().getString(R.string.gallery), true, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int i) {
                ...
                Intent intent = new Intent(AddFleetAct.this, ScanActivity.class);
                intent.putExtra(ScanConstants.OPEN_INTENT_PREFERENCE, ScanConstants.OPEN_CAMERA);
                startActivityForResult(intent, REQUEST_CODE);
                    ...
                    switch (requestcode) {
                        case 0:
                            try {
                                ...
                                options.setToolbarColor(ContextCompat.getColor(AddFleetAct.this, R.color.appbg));
                                options.setStatusBarColor(ContextCompat.getColor(AddFleetAct.this, R.color.header_text));
                                options.setToolbarWidgetColor(ContextCompat.getColor(AddFleetAct.this, R.color.header_text));
...
//        finish();
    ...
    private class StateAdapter extends RecyclerView.Adapter<StateAdapter.ViewHolder> {
        ...
        public StateAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            ...
            Colorchange.ChangeColor((ViewGroup) view, AddFleetAct.this);
