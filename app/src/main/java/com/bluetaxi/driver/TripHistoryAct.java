...
import com.bluetaxi.driver.fragments.TripDetailNewFrag;
import com.bluetaxi.driver.fragments.TripHistory;
...
//                .findViewById(android.R.id.content)).getChildAt(0)), TripHistoryAct.this);
    ...
    public void onBackPressed() {
        if (getSupportFragmentManager().findFragmentById(R.id.mainFrag) instanceof TripHistory) {
            Intent intent = new Intent(TripHistoryAct.this, HomeScreenActivity.class);
