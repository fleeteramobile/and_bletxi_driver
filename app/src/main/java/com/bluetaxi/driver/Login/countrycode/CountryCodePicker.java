package com.bluetaxi.driver.Login.countrycode;
...
//                int defaultCountryCode = a.getInteger(R.styleable.CountryCodePicker_defaultCode, -1);
            ...
            textView_selectedCountry.setText(SplashAct.CURRENT_COUNTRY_CODE);
            defaultCountryNameCode = SplashAct.CURRENT_COUNTRY_ISO_CODE;//IN
            defaultCountryCode = Integer.parseInt(SplashAct.CURRENT_COUNTRY_CODE.replace("+", ""));//+91
        } finally {
            a.recycle();
        }
