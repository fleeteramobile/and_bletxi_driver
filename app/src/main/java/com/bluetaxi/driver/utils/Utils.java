package com.bluetaxi.driver.utils;
...
import static com.bluetaxi.driver.utils.NC.getString;
    ...
    public static Dialog alert_view_dialog(final Context mContext, String title, String message,
        ...
        if (mContext != null) {
            ...
            alert.setOnShowListener(
                    arg0 -> {
                        if (mContext != null && alert != null) {
                            alert.getButton(AlertDialog.BUTTON_NEGATIVE).setTextColor(CL.getColor(R.color.button_accept));
                            alert.getButton(AlertDialog.BUTTON_POSITIVE).setTextColor(CL.getColor(R.color.black));
                        }
                    });
            alert.show();
            ...
            gpsAlert.setOnShowListener(
                    arg0 -> {
                        if (mContext != null && gpsAlert != null) {
                            gpsAlert.getButton(AlertDialog.BUTTON_NEGATIVE).setTextColor(CL.getColor(R.color.button_accept));
                            gpsAlert.getButton(AlertDialog.BUTTON_POSITIVE).setTextColor(CL.getColor(R.color.black));
                        }
                    });
            gpsAlert.show();
