package com.bluetaxi.driver.permission;
...
import com.bluetaxi.driver.TermsAndConditions;
...
//
    ...
    public void Initialize() {
        ...
        location = getColoredSpanned(NC.getString(R.string.location), CL.getColor(R.color.black));
...
//                ShowToast(DevicePermissionActivity.this, NC.getString(R.string.agreed_checkbox));
    ...
    private void moveToLoginScreen() {
        ...
        Intent i = new Intent(DevicePermissionActivity.this, UserLoginAct.class);
