...
import com.bluetaxi.driver.service.BackgroundCoreConfig;
            ...
            if (SessionSave.getSession("trip_id", SplashAct.this).equals("")) {
               // i = new Intent(SplashAct.this, MyStatus.class);
                ...
                if (SessionSave.getSession("travel_status", SplashAct.this).equals("5")) {
                    ...
                    if (SessionSave.getSession(CommonData.IS_STREET_PICKUP, SplashAct.this, false)) {
                        i = new Intent(SplashAct.this, StreetPickUpAct.class);
                        startActivity(i);
                        finish();
                    } else {
   ...
   private void  getlocationdilaog()
    {
        ...
        dialog1 = Utils.alert_view_dialog(SplashAct.this, NC.getResources().getString(R.string.version_up_title), "Blue taxi collects location to enable identication current location even when the app is closed or not in use.", "Accept", "Deny", false, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
