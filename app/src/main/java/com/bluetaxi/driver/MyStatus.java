...
import static com.bluetaxi.driver.service.FirebaseService.BOOKLATER_NOTIFICATION_ID;
...
import com.bluetaxi.driver.support.SupportActivity;
...
//                new RequestingCheckBox();
        ...
        profile.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MyStatus.this, HomeScreenActivity.class);
                startActivity(intent);
