...
import com.onewaytripcalltaxi.driver.NotificationAct;
...
import com.onewaytripcalltaxi.driver.data.apiData.DetailInfo;
    ...
    private void sendNotification(String msg) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
            ...
            contentIntent = PendingIntent.getActivity(this,
                    0, new Intent(this, MyStatus.class), PendingIntent.FLAG_UPDATE_CURRENT | PendingIntent.FLAG_MUTABLE);

        }else {
            System.out.println("received_notufication_inside"+ " "+"3");

            contentIntent =  PendingIntent.getActivity(this, 0, new Intent(this, MyStatus.class), PendingIntent.FLAG_IMMUTABLE);
