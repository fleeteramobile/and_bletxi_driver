...
import com.onewaytripcalltaxi.driver.service.BackgroundCoreConfig;
...
import com.onewaytripcalltaxi.driver.utils.CommonSettings;
   ...
   private void  getlocationdilaog()
    {
        ...
        dialog1 = Utils.alert_view_dialog(SplashAct.this, NC.getResources().getString(R.string.version_up_title), "Oneway trip taxi collects location to enable identication current location even when the app is closed or not in use.", "Accept", "Deny", false, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
