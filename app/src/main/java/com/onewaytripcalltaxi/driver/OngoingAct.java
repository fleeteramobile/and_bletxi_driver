...
import static com.onewaytripcalltaxi.driver.StreetPickUpAct.WAITING_TIME_RUN;
import static com.onewaytripcalltaxi.driver.service.LocationUpdate.currentAccuracy;
import static com.onewaytripcalltaxi.driver.service.LocationUpdate.localDistance;
...
import com.onewaytripcalltaxi.driver.adapter.SelectedServiceAdapter;
import com.onewaytripcalltaxi.driver.adapter.StopListAdapter;
...
import com.onewaytripcalltaxi.driver.toll.TollInformation;
...
import com.onewaytripcalltaxi.driver.utils.ServiceItem;
...
public class OngoingAct extends MainActivity implements ClickInterface, OnMapReadyCallback, LocalDistanceInterface, GoogleMap.OnCameraMoveStartedListener, GetAddress {
    ...
    private TextView nodataTxt, passnameTxt, speedTxt;
...
//                        lay_fare.setVisibility(View.VISIBLE);
                        ...
                        Intent intent = new Intent(OngoingAct.this, MyStatus.class);
                        startActivity(intent);
                        finish();
                    } else {
//                        lay_fare.setVisibility(View.VISIBLE);
